...
1. Basic Reference Network Generation: prepare the well-known biomedical netowks as the NFP framework reference networks. Several pathway databases have been developed for biological network research, e.g. KEGG, Reactome - ([www.reactome.org](www.reactome.org)). All of this pathway databases is well-stuied and can be used as the basic reference networks of NFP.
